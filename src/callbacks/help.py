...
def toggle_help_modal(main_n_clicks, tab_n_clicks, is_open, tab_value):
    ...
    if "button-help.n_clicks" in changed_id:
        body_txt = [
            dbc.Label(
                "1. Please use the File Manager on the left to import/load the dataset \
                               of interest."
            ),
            dbc.Label(
                '2. Click the Similarity tab. Use the "Go to" button to open DataClinic \
            ...
            dbc.Label(
                "3. Click the Manual tab to manually label images or make corrections \
                              to the previous step. Save the current labels by clicking the button \
                              Save Labels to Disk."
            ),
            dbc.Label(
                '4. Click the Probability tab. Use the "Go to" button to open MLCoach and \
            ...
            dbc.Label(
                "5. Finally, save all the labels by clicking the button Save Labels to \
                              Disk."
            ),
        ]
    # Tab instructions
